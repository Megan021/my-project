     ...
     <div className='flex mt-10 justify-center'>
        ...
        <div className='h-[30rem] w-[40rem] bg-white shadow-2xl border rounded-r-md'>
          <div className='ml-[9.5rem]'>
            <h2 className='text-4xl font-semibold mb-5 mt-9'>Login</h2>
            ...
            <button className='h-12 w-[11rem] bg-[#0D4451] text-white text-[1.3rem] pb-1 mt-9 rounded-md'>Login</button> <br />
